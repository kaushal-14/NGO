            ...
            <div class="main_menu">
            	<nav class="navbar navbar-expand-lg navbar-light">
					<div class="container">
						...
						<a class="navbar-brand logo_h" href="index.html"><img src="img/logo-1.png" alt=""></a>
                    ...
                    if($result->num_rows > 0){
                        ...
                        echo '<div class="col-md-4 col-sm-6 gallery_item">
                                        <div class="gallery_img">
                                            <img src="data:image/jpeg;base64,'.base64_encode($imgData['image']).'" alt="">
                                            <div class="hover">
                                                <a class="light" href="img/gallery/index-1.jpg"><i class="fa fa-expand"></i></a>
                                            </div>
                                        </div>
                                    </div>';
